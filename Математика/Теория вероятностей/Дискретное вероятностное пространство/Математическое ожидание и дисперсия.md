...
1) $\mathbb{D}\xi = 0 \Leftrightarrow \xi \equiv 0$
2) $\forall c = const\ :\ \mathbb{D}(c\xi) = c^2 \mathbb{D}\xi$
3) Дисперсия НЕ линейна. (Контрпример: $\eta = 2\xi$)
...
==Опр.== **Нормировка СВ** $\xi^n = \frac{\xi^c}{\sqrt{\mathbb{D}\xi}}$
...
2) $\mathbb{D}\xi^c =$ $\mathbb{E}(\xi^c - \mathbb{E}\xi_c)^2 =$ $\mathbb{E}(\xi^c)^2 = \mathbb{E}(\xi - \mathbb{E}\xi)^2$ $= \mathbb{D}\xi$
3) $\mathbb{D}\xi^n =$ $\mathbb{E}(\xi^n - \mathbb{E}\xi^n)^2 =$ $\mathbb{E}(\frac{\xi^c}{\sqrt{\mathbb{D}\xi}} - \mathbb{E}\frac{\xi^c}{\sqrt{\mathbb{D}\xi}})^2 =$ $\frac{1}{\mathbb{D}\xi}\mathbb{E}(\xi^c-\mathbb{E}\xi^c)^2$ $= \frac{\mathbb{D}\xi^c}{\mathbb{D}\xi} = 1$ 
