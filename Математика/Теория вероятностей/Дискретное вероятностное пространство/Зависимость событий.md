...
### *Геометрической представление*: события $A$ и $B$ - независимые, если $\exists$ СК в их ВП такая, что эти события в ней ЛНЗ

- **==ВАЖНО==**: Про зависимость и независимость событий можно говорить тогда и только тогда, когда эти события принадлежат одному [[Понятие вероятностного пространства|ВП]]!
...
- Из независимости в совокупности, очевидно, следует попарная независимость. Обратное неверно.
Контрпример:
...
- Одно испытание происходит в одном ВП. Если есть несколько испытаний, то они принадлежат разным ВП и говорить о независимости событий, которые связаны с этими испытаниями, просто некорректно в силу замечания выше. Поэтому определяют новое ВП, в котором эти события уже можно сравнивать.
