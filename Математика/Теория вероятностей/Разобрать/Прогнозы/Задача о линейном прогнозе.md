...
Подставим $Y^*$ во второй абсолютный момент: $\mathbb{E}(Y^* - Y)^2 =$ $\mathbb{E}(Y^* - aZ - b)^2 =$ $\mathbb{E}Y^2 + a^2\mathbb{E}Z^2 + b^2 - 2a\mathbb{E}(YZ) - 2$
...
Получается, что $L$ - ЛП. Пусть $(\xi,\ \eta) = cov(\xi,\ \eta)$. Из свойств ковариации, она:
1) билинейна
2) симметрична
